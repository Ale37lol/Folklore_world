...
<?php $__env->startSection('title', 'Deities'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($deities->isEmpty()): ?>
        <p class="text-gray-600">No deities found for the search.</p>
    <?php else: ?>
        ...
        <div class="mt-8">
            <?php echo e($deities->appends(['search' => $searchQuery])->links()); ?>

        </div>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\folklore-world\resources\views/deities/search-results.blade.php ENDPATH**/ ?>