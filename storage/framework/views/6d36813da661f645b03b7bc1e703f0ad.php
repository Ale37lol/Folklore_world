...
<?php $__env->startSection('title', 'Folklore Map'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="w-full md:w-auto">
                <select id="culture-selector"
                    ...
                    <?php $__currentLoopData = $cultures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $culture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($culture->id); ?>"><?php echo e($culture->name); ?> (<?php echo e($culture->region); ?>)</option>
    ...
    <div id="culture-index" class="overflow-y-auto" style="max-height: 600px;">
        <ul class="divide-y divide-gray-200">
            ...
            <?php $__currentLoopData = $sortedCultures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $culture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="p-3 hover:bg-gray-50 cursor-pointer transition-colors"
                    data-culture-id="<?php echo e($culture->id); ?>" onclick="focusCulture(<?php echo e($culture->id); ?>)">
                    <div class="flex items-center">
                        <div
                            class="w-3 h-3 rounded-full mr-2 
                            <?php echo e(in_array($culture->name, [
                                'Ancient Egypt',
                                'Greece',
                                'Rome / Roman Empire',
                                'Scandinavia / Vikings',
                        ...
                        <div>
                            <h4 class="font-medium"><?php echo e($culture->name); ?></h4>
                            <p class="text-sm text-gray-600"><?php echo e($culture->region); ?></p>
                        </div>
                    </div>
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        let culturesData = <?php echo $cultures->map(function ($culture) {
                return [
                    'id' => $culture->id,
                    'name' => $culture->name,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\folklore-world\resources\views/map.blade.php ENDPATH**/ ?>