...
<?php $__env->startSection('content'); ?>
    <div class="mb-8 pl-4 pr-4">
        <h1 class="text-3xl font-bold mb-4">Search results: "<?php echo e($searchQuery); ?>"</h1>
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <form action="<?php echo e(route('creatures.search')); ?>" method="GET" class="w-full md:w-auto">
                <input type="text" name="search" value="<?php echo e($searchQuery); ?>" placeholder="Search creatures..."
    ...
    <?php if($creatures->isEmpty()): ?>
        <p class="text-gray-600">No creatures found for the search.</p>
    <?php else: ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php if(file_exists($fullPath)): ?>
                                    <img src="<?php echo e(asset($relativePath)); ?>" alt="<?php echo e($creature->name); ?>"
                                        class="object-cover w-full h-full" style="object-fit: cover; object-position: top;">
                                <?php else: ?>
                                    <span class="text-gray-500 text-sm">Image not found for <?php echo e($filename); ?></span>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                        <div class="p-4">
        ...
        <div class="mt-8">
            <?php echo e($creatures->appends(['search' => $searchQuery])->links()); ?>

        </div>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\folklore-world\resources\views/creatures/search-results.blade.php ENDPATH**/ ?>